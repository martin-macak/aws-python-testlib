...
def mark_safe(loader, dumper, transformer):
    for obj_cls in _object_classes:
        ...
        transformer.add_representer(obj_cls, obj_cls.transform)


class CFLoader(SafeLoader):
    pass
...
class CFTransformer(yaml.Dumper):
    pass


init()
mark_safe(CFLoader, CFDumper, CFTransformer)
